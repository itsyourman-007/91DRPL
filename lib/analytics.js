...
// Current week, Monday..Sunday, one bucket per day — used by the
// dashboard's "Weekly Sales" chart.
function buildDailySeries(orders) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    buckets.push({ start, end, orders: 0, sales: 0, isToday: start.toDateString() === todayKey });
  }
